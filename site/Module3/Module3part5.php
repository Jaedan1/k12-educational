...
$questionsAndAnwsers = array( //use a multi dimensional array for questions and awnsers
    1 => array(
        'Question' => 'A do loop is executes a block of code how many times?',
        'Answers' => array(
            'A' => 'Multiple times',
            'B' => 'Once',
            'C' => 'Until condition is satisfied',
            'D' => 'None of the above'
        ),
        'CorrectAnswer' => 'B'
    ),
    2 => array(
        'Question' => 'How do find our external javascript file',
        'Answers' => array(
            'A' => 'Form tags',
            'B' => 'Variable type',
            'C' => 'src=""',
    ...
    3 => array(
        'Question' => 'A while loop is repeated till',
        'Answers' => array(
            'A' => 'Condition is satisfied',
            'B' => 'Repeats a certain number of times',
            'C' => 'The function is stopped by user',
            'D' => 'Onclick'
        ),
        'CorrectAnswer' => 'A'
    ),
    4 => array(
        'Question' => 'How do we organize our checkboxes',
        'Answers' => array(
            'A' => 'Store strings in script',
            'B' => 'p tags',
            'C' => 'Header tags',
            'D' => 'Form tags'
        ),
