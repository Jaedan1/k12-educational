...
$SolutionError = '';
$SolutionError2 = '';
$questionsAndAnwsers = "onclick"; //use a multi dimensional array for questions and awnsers this is jsut a test awnser
$quest2 = "a variable";
$points = 5;
$QS = '';
    ...
    <div id="wrapper">
        ...
        <div id="main">
            <div class="inner">
                ...
                <h3> Welcome to Your First Quiz!  </h3>
                <Form method = "POST" action = "">
                    <div> 
                        You will be tested on the knowlege you learned in this module! With a coding excersice below. Feel free to go back to the introduction of the second module if your confused. Do not insert script tags they are already implemented.
                    </div>
                    <br>
                    <div class = "codearea">

                    <textarea id = "htmlcode" name = "htmlinput" placeholder = "Insert your html code here! You will implement a button that prints two strings depending if you hit ok or cancel" oninput="showPreview()"></textarea>
                    <textarea id = "jscode" name = "jsinput" placeholder = "Insert your javascript code here! Code a function that will be in called in html to say confirmed if ok is clicked and say cancelled if cancel button is clicked" oninput="showPreview()"></textarea>
                 ...
                 <p></p>
                    ...
                    <h5>How did you excecute the javascript when a button is clicked </h5>
                    ...
                    <h5>What was need in the javascript before we started our if statement </h5>
                ...
                <form action="Module2part5.php">

                <input type="button" onclick="location.href='Module2part5.php';" value="Im ready to go to Quiz!" /> 
