...
$SolutionError = '';
$SolutionError2 = '';
$questionsAndAnwsers = "square brackets"; //use a multi dimensional array for questions and awnsers this is jsut a test awnser
$quest2 = "document.getElementById";
$points = 5;
$QS = '';
    ...
    <div id="wrapper">
        ...
        <div id="main">
            <div class="inner">
                ...
                <h3> Welcome to Your fifth assignment!  </h3>
                <Form method = "POST" action = "">
                    <div> 
                        You will be tested on the knowlege you learned in this module! With a coding excersice below. Feel free to go back to the introduction of the fifth module if your confused. Do not insert script tags they are already implemented.
                    </div>
                    <br>
                    <div class = "codearea">

                    <textarea id = "htmlcode" name = "htmlinput" placeholder = "Insert your html code here! You will implement method calling your array that contains 5 of your favorite foods" oninput="showPreview()"></textarea>
                 ...
                 <p></p>
                    ...
                    <h5>What kind of brackets did you use to create your array? </h5>
                    ...
                    <h5> Which line of code did u use to display your data from the object? </h5>
                ...
                <form action="Module5part5.php">

                <input type="button" onclick="location.href='Module5part5.php';" value="Im ready to go to Quiz!" /> 
