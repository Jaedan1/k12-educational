...
$SolutionError = '';
$SolutionError2 = '';
$questionsAndAnwsers = "button"; //use a multi dimensional array for questions and awnsers this is jsut a test answer
$quest2 = "id";
$points = 5;
$QS = '';
        ...
        <div id="main">
            <div class="inner">
                ...
                <Form method = "POST" action = "">
                    <div> 
                        You will be tested on the knowlege you learned in this module! With a coding excersice below. Feel free to go back to the introduction of the first module if your confused. Do not insert script tags they are already implemented.
                    </div>
                    <br>
                    <div class = "codearea">

                    <textarea id = "htmlcode" name = "htmlinput" placeholder = "Insert your html code here! You will implement a Print Hello World button" oninput="showPreview()"></textarea>
                    <textarea id = "jscode" name = "jsinput" placeholder = "Insert your javascript code here! Code a function that will be in called in html to say hello world when the button is clicked." oninput="showPreview()"></textarea>
                 ...
                 <p></p>
                    ...
                    <h5>What input type did you use to implement your button in your html code?</h5>
                    ...
                    <h5>How do we find the element in html to manipulate it?</h5>
                ...
                <form action="Module1part7.php">

                <input type="button" onclick="location.href='module1part7.php';" value="Im ready to go to Quiz!" /> 
