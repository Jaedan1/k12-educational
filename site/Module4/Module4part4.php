...
$SolutionError = '';
$SolutionError2 = '';
$questionsAndAnwsers = "style"; //use a multi dimensional array for questions and awnsers this is jsut a test awnser
$quest2 = "table data";
$points = 5;
$QS = '';
    ...
    <div id="wrapper">
        ...
        <div id="main">
            <div class="inner">
                ...
                <h3> Welcome to Your fourth assignment!  </h3>
                <Form method = "POST" action = "">
                    <div> 
                        You will be tested on the knowlege you learned in this module! With a coding excersice below. Feel free to go back to the introduction of the fourth module if your confused. Do not insert script tags they are already implemented.
                    </div>
                    <br>
                    <div class = "codearea">

                    <textarea id = "htmlcode" name = "htmlinput" placeholder = "Insert your html code here! You will implement a table displaying you and your family's names and age in the color blue. Make the webpage background yellow." oninput="showPreview()"></textarea>
                 ...
                 <p></p>
                    ...
                    <h5>What was the tag did you use to customize your background </h5>
                    ...
                    <h5>What does the tag td stand for? </h5>
                ...
                <form action="Module4part5.php">

                <input type="button" onclick="location.href='Module4part5.php';" value="Im ready to go to Quiz!" /> 
